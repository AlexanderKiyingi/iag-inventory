...
import (
	...
	"iag-inventory/backend/internal/ctxkeys"
)
...
func NewPlatformAuth(opts PlatformAuthOptions) *PlatformAuth {
	return &PlatformAuth{authMode: opts.Mode, verifier: opts.Verifier}
}

func SetAuthMode(c *gin.Context, mode string) { c.Set(ctxkeys.AuthMode, mode) }
